...
print "Query 2. Query all of the puppies that are less than 6 months old organized by the youngest first\n"
print "6-month mark is {}".format((datetime.now() - timedelta(weeks=24)).strftime("%c"))
